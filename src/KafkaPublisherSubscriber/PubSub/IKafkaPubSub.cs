...
public interface IKafkaPubSub<TKey, TValue> : IKafkaPubSub, IDisposable
{
    ...
    Task ConsumeWithRetriesAsync(Func<RetryableConsumeResult<TKey, TValue>, CancellationToken, Task> onMessageReceived, CancellationToken cancellationToken = default!);
}
